 ...
 * @since 2.0
 */
public class CustomViewBuilder implements ViewBuilder {

    private static final Logger logger =
            Logger.getLogger(CustomViewBuilder.class.toString());
     ...
     */
    public CustomViewBuilder(SwingController c) {
        // Use all the defaults
        this(c, null, null, false, CustomViewBuilder.TOOL_BAR_STYLE_FIXED, null,
     ...
     */
    public CustomViewBuilder(SwingController c, ViewerPropertiesManager properties) {
        this(c, properties, null, false, CustomViewBuilder.TOOL_BAR_STYLE_FIXED, null,
                DocumentViewControllerImpl.ONE_PAGE_VIEW,
                DocumentViewController.PAGE_FIT_WINDOW_HEIGHT, 0);
    }
     ...
     */
    public CustomViewBuilder(SwingController c, int documentViewType,
                            int documentPageFitMode) {
        // Use all the defaults
        this(c, null, null, false, CustomViewBuilder.TOOL_BAR_STYLE_FIXED,
     ...
     */
    public CustomViewBuilder(SwingController c, Font bf, boolean bt, int ts,
